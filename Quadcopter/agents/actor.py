...
class Actor:
    ...
    def build_model(self):
        ...
        net = layers.Dense(units=128, kernel_regularizer=regularizers.l2(0.01))(states)
        ...
        raw_actions = layers.Dense(units=self.action_size, activation='sigmoid',name='raw_actions',
                                   kernel_initializer=layers.initializers.RandomUniform(minval=-3e-4,maxval=3e-4))(net)
